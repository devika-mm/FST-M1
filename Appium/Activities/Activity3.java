...
public class Activity3 {
    ...
    public void addTest(){
        ...
        driver.findElement(AppiumBy.id("digit9")).click();
...
@Test
    public void subtractTest(){
        driver.findElement(AppiumBy.id("digit1")).click();
    driver.findElement(AppiumBy.id("digit0")).click();
    ...
    public void divisionTest(){
        driver.findElement(AppiumBy.id("digit5")).click();
        driver.findElement(AppiumBy.id("digit0")).click();
        driver.findElement(AppiumBy.id("div")).click();
        driver.findElement(AppiumBy.id("digit2")).click();
        driver.findElement(AppiumBy.id("equal")).click();
